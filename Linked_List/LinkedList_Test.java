...
public class LinkedList_Test {
    public static void main(String[] args) {
        ...
        //12, 13 remove element at the beginning of the list: 55
        System.out.println("Remove the element at the beginning of the list: 55");
        iterator = linkedList.listIterator();
        while ((int)iterator.next() != 55) {
            ;
        }
        iterator.remove();
        System.out.println("Now the list contains: " + linkedList);
